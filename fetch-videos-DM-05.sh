#!/bin/bash
# swipe_grow — fetch-videos-DM-05.sh
# Series: Discipline Over Motivation | backgroundPrompt: discipline morning routine gym willpower dark focused
...
echo ""; echo "━━━  DM-05 — discipline / habit failure  ━━━"; echo ""
fetch_video "DM-05-s1.mp4" "person overwhelmed too many tasks gym dark"
fetch_video "DM-05-s2.mp4" "person walking alone discipline dark morning"
