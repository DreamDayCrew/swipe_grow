#!/bin/bash
# swipe_grow — fetch-videos-WA-04.sh
# Series: Where You Actually Are | backgroundPrompt: personal finance mindset journaling desk honest dark
...
echo ""; echo "━━━  WA-04 — money mindset / journaling  ━━━"; echo ""
fetch_video "WA-04-s1.mp4" "person counting money wallet dark moody"
