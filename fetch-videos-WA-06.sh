#!/bin/bash
# swipe_grow — fetch-videos-WA-06.sh
# Series: Where You Actually Are | backgroundPrompt: own timeline personal growth path dark moody walking
...
echo ""; echo "━━━  WA-06 — own timeline / life schedule  ━━━"; echo ""
fetch_video "WA-06-s1.mp4" "person walking alone path dark moody personal journey"
