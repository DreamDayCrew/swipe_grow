#!/bin/bash
# swipe_grow — fetch-videos-MA-09.sh
# Series: Mind Audit | backgroundPrompt: breathing overwhelmed calm pause dark slow exhale
...
echo ""; echo "━━━  MA-09 — breathing / overwhelmed pause  ━━━"; echo ""
fetch_video "MA-09-s1.mp4" "person slow breathing calm dark close up face"
