#!/bin/bash
# swipe_grow — fetch-videos-MA-04.sh
# Series: Mind Audit | backgroundPrompt: body scan meditation mindfulness calm indoor
...
echo ""; echo "━━━  MA-04 — body scan / mindfulness  ━━━"; echo ""
fetch_video "MA-04-s1.mp4" "person sitting still calm dark room meditation"
fetch_video "MA-04-s2.mp4" "quiet indoor soft light window thinking dark"
